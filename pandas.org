...
- Import data
  ...
  #+RESULTS:
- Set ~price~, ~volume~ and ~returns~
  #+begin_src hy :session Hy :results output
  (setv price (pd.DataFrame (dfor [ticker data] (all-data.items) [ticker (get data "Adj Close")])))
  (setv volume (pd.DataFrame (dfor [ticker data] (all-data.items) [ticker (get data "Volume")])))
  (setv returns (price.pct-change))
  (.tail returns)
  #+end_src
  ...
  : |---------------------+-------------+-------------+------------+-------------|
  : | 2020-06-24 00:00:00 | -0.017652   | -0.0250398  | -0.0201575 | -0.0221523  |
  : | 2020-06-25 00:00:00 |  0.0132756  |  0.0224188  |  0.0126365 |  0.00653644 |
  : | 2020-06-26 00:00:00 | -0.0307258  | -0.0154583  | -0.0200159 | -0.0564964  |
  : | 2020-06-29 00:00:00 |  0.0230467  |  0.0218448  |  0.0107472 |  0.0257886  |
  : | 2020-06-30 00:00:00 |  0.00834758 |  0.00851772 |  0.0255492 |  0.0133623  |
